...
if __name__ == '__main__':
    ...
    root_dir = '/media/wy/dataset/vkitti3D-dataset-master/virtual_kitti'
    out_dir = '/media/wy/dataset/vkitti3D-dataset-master/virtual_kitti_intensity_preprocess'
