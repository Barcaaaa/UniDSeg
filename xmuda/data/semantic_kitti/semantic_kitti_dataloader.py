    ...
    def __init__(self,
        ...
        if pselab_paths:
            ...
            if self.pselab_data[0]['probs_ensemble'] is not None:
                ...
                # pseudo_label_ensemble = refine_pseudo_labels(probs_ensemble, pseudo_label_ensemble)
            else:
...
class SemanticKITTISCN(SemanticKITTIBase):
    ...
    def __getitem__(self, index):
        ...
        # intensity = data_dict['intensity'].copy().reshape(-1, 1)
        ...
        depth[img_indices[:, 0], img_indices[:, 1]] = pts_cam_coord[:, 2] / 80.  # normalize, max_depth=79.65
        ...
        if self.pselab_data is not None:
            ...
            if self.pselab_data[index]['pseudo_label_3d'] is None:
                ...
                out_dict['pseudo_label_ensemble'] = self.pselab_data[index]['pseudo_label_ensemble'][keep_idx][idxs]
