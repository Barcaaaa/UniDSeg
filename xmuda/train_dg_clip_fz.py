...
from xmuda.common.solver.build import build_optimizer, build_scheduler, build_optimizer_fz
...
from xmuda.models.ft_fz_clip.build import build_model_2d, build_model_3d
...
def train(cfg, output_dir='', run_name=''):
    ...
    # build optimizer
    optimizer_2d = build_optimizer_fz(cfg, model_2d)
